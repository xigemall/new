...
/* ----------------------------------------------------------------------- *\
   ...
   ������Ĺ���:
     ...
     ���� scws-1.0 (��Cʵ��) ��һ�� PHP ʵ�ַ�ʽ, �㷨�͹���һ��
     ���������ַ����ı�ִ�зִ�, ���ݴʵ�N-·�������ʷ��ִ�.
	 
	 ֧������������������ʶ����ʶ�� .NET, C++, Q�� ֮������ʻ�
	 ֧�� UTF-8/GBK ����, �ر�Ϊ�������濼����֧�ֳ�����ϸ�ֵĸ����ִʷ�
	 ʹ�� UTF-8 ����չ���κζ��ֽ����Էִ�(����������)
...
define ('PSCWS4_WORD_PART',		0x02);	// ����: ǰ�ʶ�
define ('PSCWS4_WORD_USED',		0x04);	// ����: ��ʹ��
define ('PSCWS4_WORD_RULE',		0x08);	// ����: �Զ�ʶ���

define ('PSCWS4_ZFLAG_PUT',		0x02);	// ����: ��ʹ��
define ('PSCWS4_ZFLAG_N2',		0x04);	// ����: ˫������ͷ
define ('PSCWS4_ZFLAG_NR2',		0x08);	// ����: ��ͷ��Ϊ˫������
define ('PSCWS4_ZFLAG_WHEAD',	0x10);	// ����: ��ͷ
define ('PSCWS4_ZFLAG_WPART',	0x20);	// ����: ��β�����
define ('PSCWS4_ZFLAG_ENGLISH',	0x40);	// ����: �����м��Ӣ��
define ('PSCWS4_ZFLAG_SYMBOL',	0x80);	// ����: ����ϵ��
...
{	
	...
	function get_result()
	{
		...
		while (($off = ($off + $clen)) < $len)
		{
			...
			{
				// mb + single-byte. allowd: alpha+num + ����
	...
	function _mset_word($i, $j)
	{
		...
		// hightman.070705: ���� item == null �ж�, ��ֹ������(255������)unsigned char���
